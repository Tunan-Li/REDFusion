...
class JsonlDataset(Dataset):
    def __init__(self, data_path, tokenizer, transforms, vocab, args):
        ...
        # self.data = {"id": "477", "label": "positive", "text": "It's been five years, but I'm more than overjoyed to wish you a happy 23rd birthday, I love you baby. Rest easy. ??? ", "img": "data/477.jpg"}
        # 当然肯定不止一个

        self.data_dir = os.path.dirname(data_path)  # ./datasets/MVSA_Single

        self.tokenizer = tokenizer
        self.args = args
        self.vocab = vocab
        self.n_classes = len(args.labels)  # 3 在 MVSA-single 数据集上是这样
    ...
    def __getitem__(self, index):
        ...
        image = None
        if self.args.model in ["img", "concatbow", "concatbert", "mmbt", "latefusion", "tmc", "early_wd"]:
